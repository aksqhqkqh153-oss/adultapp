...
$zip = "C:\Users\최성규\Downloads\adultapp_20260421_splash_screen_resize_fix.zip"
$branch = "main"
...
$commitMsg = "update: enlarge splash image display"
...
npm run build
if (!(Test-Path (Join-Path $dist "index.html"))) { throw "dist\\index.html 파일이 없습니다: $dist" }
...
Write-Host "7) Git 커밋 + 푸시 (Railway backend 자동 배포 트리거)"
Set-Location $project
git add .
