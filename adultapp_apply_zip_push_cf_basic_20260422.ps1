...
$zip = "C:\Users\icj24\Downloads\adultapp_20260422_git_cf_basicfix.zip"
$branch = "main"
$commitMsg = "update: apply latest adultapp zip"
...
Write-Host ""
Write-Host "완료: ZIP 덮어쓰기 -> Git 최신화 -> Git 반영/Push -> Cloudflare Pages 업로드"
