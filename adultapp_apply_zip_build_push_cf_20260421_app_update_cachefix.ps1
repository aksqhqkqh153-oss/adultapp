...
$zip = "C:\Users\최성규\Downloads\adultapp_20260421_app_update_cachefix.zip"
$branch = "main"
...
$commitMsg = "update: improve mobile app refresh and asset cache busting"
...
if (!(Test-Path (Join-Path $dist "version.json"))) {
    throw "dist\version.json 파일이 없습니다: $dist"
}
...
if ($LASTEXITCODE -gt 7) {
    throw "robocopy 실패 코드: $LASTEXITCODE"
}
