...
$zip = "C:\Users\icj24\Downloads\adultapp_20260422_mime_fix.zip"
$branch = "main"
$commitMsg = "update: fix mime type deploy issue"
...
function Test-BuildOutput {
    ...
    $assetJs = Get-ChildItem (Join-Path $DistPath "assets") -Filter *.js -ErrorAction SilentlyContinue
    if (!($assetJs | Select-Object -First 1)) {
        throw "배포 금지: dist/assets 안에 js 파일이 없습니다."
    }
}
